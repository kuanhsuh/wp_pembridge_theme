...
<section class="news">
  <div class="container">
    ...
    $loop = new WP_Query(array('post_type' => 'latest_news', 'orderby' => 'post_id', 'order' => 'ASC', 'posts_per_page' => '3', 'paged' => $paged)); ?>
    <?php while ($loop->have_posts()) : $loop->the_post(); ?>
      ...
      <div class="row justify-content-center mt-4">
        ...
        <div class="col-md-6">
          ...
          <a href="<?php the_permalink(); ?>" class="btn btn-lg btn-outline-dark text-uppercase float-right px-5" style="font-weight:300;">Read more...</a>
        </div>
        <!-- col -->
      </div>
      <!-- row -->
